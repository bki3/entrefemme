...
<head>
    ...
    <title>Testimonials - Entre Femme </title>
...
<div class="col-lg-12">
        <h4 class="text-center" id="line">
            <span class="text-light p-1 px-5" style="background-color: #DF678B;">Testimonials</span>
        </h4>
        <p class="text-center">What our clients say about us</p>
    </div>
