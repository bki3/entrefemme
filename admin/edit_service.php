...
if(isset($_GET['id'])){
	$id = $_GET['id'];
	$stmt = mysqli_query($con, "SELECT * FROM `services` WHERE `id` = '$id'");
}else{ echo "<script>window.location.href='services.php';</script>"; }
...
<a href="add_service.php"> <button class="btn btn-primary btn-sm rounded-0">
  Add New Service
</button></a>
