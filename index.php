...
$stmtee = mysqli_query($con, "SELECT * FROM `post` WHERE `status` = '0' ORDER BY `id` DESC LIMIT $latest_limit");
$stmt2 = mysqli_query($con, "SELECT * FROM `post` WHERE `slider` = '1' AND `status` = '0' ORDER BY `id` DESC LIMIT 3");
$stmt3 = mysqli_query($con, "SELECT * FROM `post` WHERE `feature` = '1' AND `status` = '0' ORDER BY `id` DESC LIMIT $feature_limit ");
$stmt5 = mysqli_query($con, "SELECT * FROM `post` WHERE `status` = '0' ORDER BY `views` DESC  LIMIT $popular_limit");
$stmt6 = mysqli_query($con, "SELECT * FROM `post` WHERE `status` = '0' ORDER by `id` DESC LIMIT $comment_limit");
...
$metatitle = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `settings` WHERE `setting_name` = 'metatitle'"))['setting_value'];
...
<head>
    ...
    <meta name="keywords" content="entrefemme, entre, entre femme, blog, article, entrefemme.com"><meta name="description" content="<?php echo $metadesc['setting_value']; ?>">
    ...
    <link rel="stylesheet" href="assets/css/ticker-style.css" defer>
...
<meta name="google-adsense-account" content="ca-pub-6316376535287964">
...
<meta name="google-adsense-account" content="ca-pub-9593631681321173">
<meta property="twitter:description" content="<?php echo $twitter['description']; ?>">
<meta property="twitter:image" content="<?php echo str_replace('../','', $twitter['image']); ?>"><?php echo $adsense; ?>
...
<div class="col-lg-2 d-none d-sm-block d-xs-block">
...
<div class="row">
    <div class="col">
       <div class="home-banner2 d-none d-lg-block mt-3">
            <a href="#"><img src="<?php echo trim(strtolower(str_replace("../","",$adon['setting_value']))); ?>" alt="<?php echo trim(strtolower($adon['setting_name'])); ?>" height="auto" width="100%"></a>
        </div>
    </div>
</div>
    ...
    <div class="single-slider">
        <div class="trending-top mb-30">
            <div class="trend-top-img">
                ...
                <img src="'.str_replace("../","",$slider['picture']).'" width="100%" height="auto" alt="'.$slider['category'].'"></a>
        ...
        <div class="col-lg-6 mt-2">
            <div class="weekly2-single">
                <div class="weekly2-img">
                    <a href="blog_details.php?id='.$feature['id'].'"><img src="'.str_replace("../","",$feature['picture']).'" alt="" width="100%"></a>
                </div>
...
$uq = mysqli_query($con, "SELECT * FROM `videos` ORDER BY `id` DESC LIMIT $watch_limit");
        ...
        <div class="card-body px-2">
            <div class="row">
                <div class="col-4 mr-1">
                    <a href="blog_details.php?id='.$popular['id'].'"><img src="'.str_replace("../","",$popular['picture']).'" alt="no image" width="125%"></a>
                </div>
                <div class="col-7">
...
<div class="home-banner2 d-none d-lg-block mt-3">
    <a href="#">
    <img src="<?php echo trim(strtolower(str_replace("../","",$adtw['setting_value']))); ?>" alt="<?php echo trim(strtolower($adtw['setting_name'])); ?>" height="auto" width="auto">
    </a>
</div>
            ...
            <div class="single-slider">
                <div class="trending-top my-3 p-0">
                    <div class="trend-top-img h-100">
                        <a href="blog_details.php?id='.$bottom['id'].'"><img src="'.str_replace("../","",$bottom['picture']).'" alt="" width="100%"></a>
                    <div class="trend-top-cap">
