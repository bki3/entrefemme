...
<head>
    ...
    <title><?php echo $data['title']; ?> Service - Entre Femme </title>
    ...
    <section class="blog_area my-5">
        ...
        <div class="col-lg-12">
            <h4 class="text-center" id="line">
                <span class="text-light p-1 px-5" style="background-color: #DF678B;">Service</span>
            </h4>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
				<h1>'.$data['title'].'</h1><br>
				<img src="./assets/img/'.$data['image'].'" alt="'.$r['title'].'" width="100%">
                        </div>
