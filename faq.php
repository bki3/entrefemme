...
<head>
    ...
    <title>Frequenty Asked Questions - Entre Femme </title>
...
<div class="col-lg-12">
        <h4 class="text-center" id="line">
            <span class="text-light p-1 px-5" style="background-color: #DF678B;">FAQ's</span>
        </h4>
                    ...
                    if(mysqli_num_rows($sql) > 0){
                        while($rows = mysqli_fetch_assoc($sql)){
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-3">
                                ...
                                <button id="btn'.$rows['id'].'" class="btn btn-danger w-100 rounded-0">'.$rows['question'].'</button>
                                
                                <div id="data'.$rows['id'].'">
                                    <p class="text-justify py-2">'.$rows['answer'].'</p>
                                </div>
                                
                                <script>
                                $(document).ready(function(){
                                    $("#btn'.$rows['id'].'").click(function(){
                                      $("#data'.$rows['id'].'").toggle();
                                    });
                                });
                                </script>
